...
token = "1663481633:AAEwm-uy0UX0mEjGDFKsMMxqF6edMX-KrZA" #Bot token (Example: 93181085:AAELcePZ1qabYrDiu0t1PVPuw1HI0zXzXmq)
cert = "/home/server.crt" #SSL certificate (Can not be self-signed)
key = "/home/server.key"  #SSL key (Can not be self-signed)
